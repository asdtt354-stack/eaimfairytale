const CACHE_NAME='muni-story-v38';
const APP_SHELL=[
  './','./index.html','./manifest.webmanifest','./css/styles.css',
  './js/app.js','./js/ai-voice.js','./js/recorder.js','./js/creator-config.js','./js/creator.js','./js/creator-music.js','./js/village-studio.js','./js/vendor/jszip.min.js','./js/pwa.js','./js/learning.js','./js/language.js','./js/firebase-sync.js',
